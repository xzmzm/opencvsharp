...
rotatedPatternMatcher_RotatedPatternMatcher_new(RotatedPatternMatcher **returnValue)
{
	BEGIN_WRAP
	*returnValue = new RotatedPatternMatcher();
	END_WRAP
}
CVAPI(ExceptionStatus)
rotatedPatternMatcher_RotatedPatternMatcher_delete(RotatedPatternMatcher *obj)
{
	BEGIN_WRAP
	delete obj;
	END_WRAP
...
CVAPI(ExceptionStatus)
rotatedPatternMatcher_RotatedPatternMatcher_teach(RotatedPatternMatcher *obj, cv::Mat *pattern, int pyramidLevels)
{
	BEGIN_WRAP
	obj->m_iPyramidLevels = pyramidLevels;
	obj->teach(pattern);
	END_WRAP
}
CVAPI(ExceptionStatus)
