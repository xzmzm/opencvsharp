...
namespace cuda_icp
{
    ...
    public:
        ...
        ICPConvergenceCriteria(float relative_fitness = 1e-3f,
                               float relative_rmse = 1e-3f, int max_iteration = 30, double penalty = 0.01) : relative_fitness_(relative_fitness), relative_rmse_(relative_rmse),
                                                                                                             max_iteration_(max_iteration), penalty_(penalty) {}
    ...
    Mat3x3f eigen_slover_444(float *A, float *b, double penalty = 0.01);
