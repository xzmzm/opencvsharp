...
template <> template <> __device__ __host__
inline vec<3,float>::vec(const vec<3,int> &v)   : x(static_cast<float>(v.x)),y(static_cast<float>(v.y)),z(static_cast<float>(v.z)) {}
template <> template <> __device__ __host__
inline vec<2,int>  ::vec(const vec<2,float> &v) : x(int(v.x+.5f)),y(int(v.y+.5f)) {}
template <> template <> __device__ __host__
inline vec<2,float>::vec(const vec<2,int> &v)   : x(static_cast<float>(v.x)),y(static_cast<float>(v.y)) {}
